class Main {
  ...
  void init(){
    ...
    if((student1.calculateAvg() >= 60 && student1.calculateAvg() <= 70)&& student1.gradeLevel<=10){
      System.out.println(student1.firstName);
    }

    if((student2.calculateAvg() >= 60 && student2.calculateAvg() <= 70)&& student2.gradeLevel<=10){
      System.out.println(student2.firstName);
    }
